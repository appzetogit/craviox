  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (step2.profileImage instanceof File) {
        profileImageData = await handleUpload(step2.profileImage, "craviox/restaurant/profile")
      ...
      for (const file of step2.menuImages.filter(f => f instanceof File)) {
        const uploaded = await handleUpload(file, "craviox/restaurant/menu")
      ...
      if (step3.panImage instanceof File) {
        panImageData = await handleUpload(step3.panImage, "craviox/restaurant/pan")
      ...
      if (step3.gstRegistered && step3.gstImage) {
        if (step3.gstImage instanceof File) {
          gstImageData = await handleUpload(step3.gstImage, "craviox/restaurant/gst")
      ...
      if (step3.fssaiImage instanceof File) {
        fssaiImageData = await handleUpload(step3.fssaiImage, "craviox/restaurant/fssai")
